...
export default function Login()
{
	...
	{
	signInWithPopup(loginAuth, provider)
  .then((result) => {
  ...
  .catch((error) => {
    ...
    return(
        <div className="grid grid-cols-2 items-center mx-12 gap-4">
            <div>
                <h3 className="text-4xl font-bold text-blue-700">Join Us Today <br></br> and <span className="font-normal">get your own cave</span></h3>
            </div>
            <div>
            <form className="flex  max-w-lg flex-col rounded-xl border border-border sm:p-8" onSubmit={handleManualSignOn}>
	<div className="flex w-full flex-col gap-2 items-center" >
		<p>Sign in with</p>
		<div className="flex gap-2">
			<button type="button" className="btn gap-2 bg-white" onClick={handleGoogleAuth}>
			...
			<button type="button" className="btn gap-2 bg-white">
	...
	<div className="form-group">
		<div className="form-field">
			...
			<input placeholder="Type here" type="email" ref={emailRef} className="input max-w-full" />
		...
		<div className="form-field">
			...
			<div className="form-control">
				<input placeholder="Type here" type="password" ref={passwordRef} className="input max-w-full" />
			</div>
		</div>
		<div className="form-field">
